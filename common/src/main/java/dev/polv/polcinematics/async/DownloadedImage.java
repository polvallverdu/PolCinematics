...
import dev.polv.polcinematics.utils.render.DynamicResourceLocation;
import dev.polv.polcinematics.utils.render.SelfCleaningDynamicTexture;
...
public class DownloadedImage {
    ...
    public DownloadedImage(BufferedImage image) {
        ...
        this.resourceLocation = new DynamicResourceLocation(PolCinematics.MOD_ID, image.hashCode() + "cin"); // TODO: Make it work
